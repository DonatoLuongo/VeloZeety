...
import { Package, MapPin, User, Phone, FileText, ArrowRight, Truck, Bike, Car, Shield, Navigation, X } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-6 animate-fade-in-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Sección Ruta con Autocompletado Real (Nominatim) */}
        <section className="bg-white dark:bg-[#1E2329] rounded-2xl border border-slate-200 dark:border-[#2B3139] p-6 shadow-sm">
          ...
          <div className="space-y-4 relative">
            ...
            {/* Origen con Geolocalización + Autocompletado real */}
            <div className="relative pl-12">
              ...
              <AddressAutocomplete
                ...
                required
                className={`${tipoLogistica === 'mandaito' ? INPUT_CLASS : BLUE_INPUT_CLASS}`}
                showGeolocate
                countryCode="ve"
              />
            </div>

            {/* Destino con Autocompletado real */}
            <div className="relative pl-12">
            ...
            {tipoLogistica === "flete" && (
              <div className="grid grid-cols-2 gap-4 animate-fade-in">
                ...
                <select className={BLUE_INPUT_CLASS + " appearance-none cursor-pointer"}>
                  <option className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Sin ayudante</option>
                  <option className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">1 Ayudante de carga</option>
                  <option className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">2 Ayudantes de carga</option>
                </select>
              </div>
            )}

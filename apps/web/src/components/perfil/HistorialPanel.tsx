...
export default function HistorialPanel({ embedInDashboard }: HistorialPanelProps) {
  return (
    <div className={embedInDashboard ? "w-full max-w-4xl" : "max-w-2xl mx-auto p-4 md:p-6"}>
      ...
      <div className="bg-white dark:bg-velocity-surface rounded-2xl border border-slate-200 dark:border-white/10 p-10 text-center text-slate-500 dark:text-slate-400 text-base transition-colors">
